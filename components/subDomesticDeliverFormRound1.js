...
const SubDomesticDeliverFormRound1 = ({
  setDeliverAddressWrite,
  closeIcon,
  selectedSuggestDeliverPinCodeDomestic,
  selectedSuggestDeliverCityDomestic,
  selectedSuggestDeliverStateDomestic,
  setDeliverContactName,
  setDeliverEmail,
  setDeliverFlatNumber,
  setDeliverMobileNo,
  setDeliverStreet,
  setDeliverFormSubmit,
}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      setFormErr(false);
      setDeliverAddressWrite(false);
      setDeliverContactName(contactName);
      setDeliverEmail(email);
      setDeliverFlatNumber(flatNumber);
      setDeliverMobileNo(mobileNumber);
      setDeliverStreet(street);
      setDeliverFormSubmit(true);
    } else {
      setFormErr(true);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-5 rounded-lg shadow-lg relative h-[90vh] w-[46vw] overflow-y-auto scrollbar">
        <div
          ...
          onClick={() => setDeliverAddressWrite(false)}
        >
          {closeIcon}
        </div>
        <h1 className="text-lg font-bold mb-3">Add Deliver Address</h1>
        <form className="space-y-3" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              value={selectedSuggestDeliverPinCodeDomestic}
              readOnly
              type="text"
              className="w-full px-2 py-1 border rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          ...
          <div>
            ...
            <input
              type="text"
              value={selectedSuggestDeliverCityDomestic}
              readOnly
              name="city"
              className="w-full px-2 py-1 border rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          ...
          <div>
            ...
            <input
              value={selectedSuggestDeliverStateDomestic}
              readOnly
              type="text"
              className="w-full px-2 py-1 border rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
...
export default SubDomesticDeliverFormRound1;
